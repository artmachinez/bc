...
namespace EditableWebBrowser.EWBInterop
{
    ...
    //public enum FRAMEOPTIONS_FLAGS
    //{
    ...
    public enum DOCHOSTUIFLAG
    {
        ...
        ENABLE_ACTIVEX_INACTIVATE_MODE = 0x00000010
    }
